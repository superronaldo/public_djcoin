...
return [
    ...
    */
    ...
    'api_key' => env('SHOPIFY_API_KEY', '5d5fbb5d1c2471e1a876b17757c3b761'),
    ...
    */
    ...
    'api_secret' => env('SHOPIFY_API_SECRET', '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'),
    ...
    */
    ...
    'api_scopes' => env('SHOPIFY_API_SCOPES', 'read_orders,write_orders,read_customers,write_customers,read_products,write_products,read_price_rules,write_price_rules,read_discounts,write_discounts'),
