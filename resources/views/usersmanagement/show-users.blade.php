                            ...
                            <table class="table table-striped table-sm data-table">
                                ...
                                <thead class="thead">
                                    <tr>
                                        ...
                                        <th class="hidden-sm hidden-xs hidden-md">Wallet Address</th>
                                        <th class="hidden-sm hidden-xs hidden-md">Amount</th>
                                ...
                                <tbody id="users_table">
                                    @foreach($users as $user)
                                        <tr>
                                            ...
                                            <td class="hidden-sm hidden-xs hidden-md">{{$user->wallet_address}}</td>
                                            <td class="hidden-sm hidden-xs hidden-md">{{$user->amount}}</td>
